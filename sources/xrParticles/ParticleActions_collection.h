//==================================== BlackHoleEngine ============================================
// Projekt		: Particles
// Module		: ParticleActions_collection.h
// Author		: Anahoret
// Description	: 
//================================== SovaHiBlack© - 2022 ==========================================

#pragma once
#ifndef PARTICLES_PARTICLEACTIONS_COLLECTION_H_INCLUDED
#define PARTICLES_PARTICLEACTIONS_COLLECTION_H_INCLUDED
...
#define _METHODS	virtual void	Load		(IReader& F);					\
					...
					virtual void	Execute		(SParticleEffect* pe, f32 dt);	\
	...
	{
		// Endpoints of line to which particles are attracted (in local space)
		CParticleVector		pL;
		CParticleVector		axisL;

		// Endpoints of line to which particles are attracted
		CParticleVector		p;
		CParticleVector		axis;
...
//---------------------------------------------------------------------------
#endif // ndef PARTICLES_PARTICLEACTIONS_COLLECTION_H_INCLUDED