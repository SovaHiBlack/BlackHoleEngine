...
const float SEffectPars::vel_cret_sound					= 10.0f;
const float SEffectPars::vel_cret_particles				= 15.0f;
const float SEffectPars::vel_cret_wallmark				= 30.0f;

const float SCharacterEffectPars::vel_cret_sound		= 20.0f;
const float SCharacterEffectPars::vel_cret_particles	= 60.0f;
const float SCharacterEffectPars::vel_cret_wallmark		= 100.0f;
