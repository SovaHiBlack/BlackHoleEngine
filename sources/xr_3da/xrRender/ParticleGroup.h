...
namespace PS
{
	...
	public:
        ...
        public:
            ...
            void			StartRelatedChild	(CParticleEffect* emitter, LPCSTR eff_name, PAPI::SParticle& m);
            void			StopRelatedChild	(u32 idx);
            void			StartFreeChild		(CParticleEffect* emitter, LPCSTR eff_name, PAPI::SParticle& m);
